...
|---|---|---|
| `text_spans` | `list[dict]` | Span list produced by `detect.process_pdf`. Each entry: `{"page": int, "text": str, "font": {"size": float, "flags": int, "matched_font": str}}` |
