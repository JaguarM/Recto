...
class OcrTool(PDFTool):
    ...
    scripts_after_app = [
        ...
        {'path': 'ocr_tool/engine/blindocr.js', 'version': 'v=569936de'},
        {'path': 'ocr_tool/engine/render.js', 'version': 'v=cccd779d'},
        ...
        {'path': 'ocr_tool/ocr-tool.js', 'version': 'v=11'},
        {'path': 'ocr_tool/pixel-view.js', 'version': 'v=8'},
