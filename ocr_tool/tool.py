...
class OcrTool(PDFTool):
    ...
    scripts_after_app = [
        ...
        {'path': 'ocr_tool/engine/blindocr.js', 'version': 'v=1ffb3653'},
        {'path': 'ocr_tool/engine/render.js', 'version': 'v=acc085a8'},
        {'path': 'ocr_tool/engine/set-fonts.js', 'version': 'v=29e7faf6'},
        {'path': 'ocr_tool/engine/hypothesis.js', 'version': 'v=f9e013f6'},
        {'path': 'ocr_tool/engine/ftraster.js', 'version': 'v=0894c30a'},
        ...
        {'path': 'ocr_tool/ocr-result.js', 'version': 'v=3'},
        {'path': 'ocr_tool/ocr-tool.js', 'version': 'v=12'},
        {'path': 'ocr_tool/pixel-view.js', 'version': 'v=9'},
